...
description: Use when changing, refactoring, reviewing, testing, or extending the game-design-tools project, especially project management, local/remote storage, asset caching, workspace modules, architecture guards, and release checks.
---
