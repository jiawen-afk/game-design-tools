...
test('image processing upscale is an optional export enhancement and keeps normal export available', () => {
  ...
  assert.match(desktopUpscaleApiSource, /upscaleImageBatch/)
  ...
  assert.match(preloadSource, /upscaleImageBatch: \(options\) => invoke\('upscayl:upscale-batch', options\)/)
  ...
  assert.match(upscaylIpcSource, /upscayl:upscale-batch/)
