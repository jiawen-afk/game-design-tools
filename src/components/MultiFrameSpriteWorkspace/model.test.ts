...
test('sprite export can be collected into project space with sprite and index resources', () => {
  ...
  assert.match(exportHook, /collectPersonalSpaceAsset/)
  assert.match(exportHook, /assignAssetToCharacterColumn/)
  assert.match(exportHook, /writeAssetResourcesWithGeneratedCoverToDirectory/)
  assert.doesNotMatch(exportHook, /writeAssetResourcesToDirectory/)
  assert.match(exportHook, /readCurrentProjectSpaceState/)
  assert.match(exportHook, /persistCurrentProjectSpaceState/)
  assert.doesNotMatch(exportHook, /writeCurrentProjectSpaceState/)
  assert.match(exportHook, /personalSpaceDirectoryRequiredMessage/)
  assert.doesNotMatch(exportHook, /collectToPersonalSpace[\s\S]*archiveAssetForStorageDirectory/)
  assert.match(exportHook, /项目空间-素材-精灵图/)
