...
export function assignAssetToCharacterColumn(state: PersonalSpaceState, characterId: string, assetId: string, column: 'portrait' | 'sprite' | 'voice'): PersonalSpaceState {
  const next = clonePersonalSpaceState(state)
