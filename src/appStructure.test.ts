...
test('remote profile editing requires tested drafts and preserves blank secrets', () => {
  ...
  assert.match(hookSource, /getRemoteProfileDraftStatus/)
  assert.match(hookSource, /createDatabaseProfileSaveInput/)
  assert.match(hookSource, /createKodoProfileSaveInput/)
  ...
  assert.doesNotMatch(hookSource, /schemaInitializedAt: shouldKeepDatabaseSchemaInitialization/)
  assert.doesNotMatch(hookSource, /databaseDraftTestState !== 'untested'/)
  assert.doesNotMatch(hookSource, /kodoDraftTestState !== 'untested'/)
