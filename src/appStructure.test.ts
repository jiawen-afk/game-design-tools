...
test('remote project workspace changes sync through project storage service', () => {
  ...
  assert.match(remoteSyncSource, /const syncActiveProjectStateToStorage = async \(nextSpace: PersonalSpaceState\)/)
...
test('remote project realtime sync is debounced and has a periodic fallback', () => {
  ...
  assert.match(remoteSyncSource, /const queuedRemoteSyncSpaceRef = useRef<PersonalSpaceState \| null>\(null\)/)
  ...
  assert.doesNotMatch(workspaceSource, /queuedRemoteSyncSpaceRef/)
