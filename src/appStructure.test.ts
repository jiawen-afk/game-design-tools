...
test('project management exposes remote database and qiniu kodo configuration', () => {
  ...
  assert.match(updateRemoteProjectLinksSource, /bindRemoteProjectToCurrentDevice\(\s*projectId,\s*settingsWorkspace\.selectedDatabaseProfileId,\s*settingsWorkspace\.selectedKodoProfileId/s)
