...
test('remote project profile ids stay local and shared settings are not used as device bindings', () => {
  ...
  assert.match(bindingSource, /currentDeviceBindingForProject\(projectId\)\?\.databaseProfileId/)
  assert.match(bindingSource, /currentDeviceBindingForProject\(projectId\)\?\.storageProfileId/)
...
test('personal space workspace delegates storyboard management panel', () => {
  ...
  assert.match(panelSource, /resolveProjectAssetResourceSource/)
