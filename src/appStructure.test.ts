...
test('personal space resource kinds are first-level tabs instead of a common resource tab', () => {
  ...
  assert.match(sectionsSource, /export function PersonalAssetPreview/)
  ...
  assert.match(sectionsSource, /preview-image/)
  assert.match(sectionsSource, /audioRef/)
  assert.match(sectionsSource, /spritePlaying/)
  assert.match(sectionsSource, /spriteFrameIndex/)
  assert.match(sectionsSource, /window\.setInterval/)
