...
test('image crop panel owns crop aspect ratio while export panel scales locked output size', () => {
  ...
  assert.match(exportSource, /workspace\.updateExportDimension\('width', value\)/)
  assert.match(exportSource, /workspace\.updateExportDimension\('height', value\)/)
  assert.doesNotMatch(exportSource, /readOnly/)
